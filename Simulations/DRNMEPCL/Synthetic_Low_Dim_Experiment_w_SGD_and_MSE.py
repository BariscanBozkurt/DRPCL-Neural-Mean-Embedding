...
csv_name_for_results = f"../Results/Synthetic_Low_Dim_Experiment/DRPCLNET_SyntheticLowDim_Results_with_MSE_and_SGD_{data_sizes_str}_{current_date}.csv"

print(f"Running simulation for sizes: {data_size_list}")

print("Running the script Synthetic_Low_Dim_Experiment_w_SGD_and_MSE to generate results and save at {}".format(csv_name_for_results))
