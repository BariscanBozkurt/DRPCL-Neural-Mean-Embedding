...
csv_name_for_results = f"../Results/Synthetic_Low_Dim_Experiment/DRPCLNET_SyntheticLowDim_Results_with_MSEClosedForm_{data_sizes_str}_{current_date}.csv"

print(f"Running simulation for sizes: {data_size_list}")

print("Running the script Synthetic_Low_Dim_Experiment_w_ClosedForm to generate results and save at {}".format(csv_name_for_results))
