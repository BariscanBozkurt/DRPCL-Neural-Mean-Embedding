...
csv_name_for_results = f"../Results/CATE_Synthetic_Experiment/DRPCLNET_SyntheticCATE_Results_with_SGD_and_huber_{data_sizes_str}_{current_date}.csv"

print(f"Running simulation for sizes: {data_size_list}")

print("Running the script Synthetic_CATE_Experiment_with_SGD_and_MSE to generate results and save at {}".format(csv_name_for_results))
