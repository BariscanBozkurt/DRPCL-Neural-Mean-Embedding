...
csv_name_for_results = f"../Results/dSprite_Experiment/DRPCLNET_dsprite_Results_with_mse_{data_sizes_str}_{current_date}.csv"

print(f"Running simulation for sizes: {data_size_list}")

print("Running the script dSprite_Experiment_w_SGD_mse_and_KLIEP to generate results and save at {}".format(csv_name_for_results))
